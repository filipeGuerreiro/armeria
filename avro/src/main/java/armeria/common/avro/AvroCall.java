 ...
 */
@JsonSerialize(using = AvroJacksonSerializers.ThriftCallJsonSerializer.class)
public final class AvroCall extends AvroMessage {
     ...
     * message.
     */
    public AvroCall(TMessage header, TBase<?, ?> args) {
        super(header);
    ...
    public boolean equals(@Nullable Object o) {
        ...
        if (!(o instanceof AvroCall)) {
            return false;
        }

        return super.equals(o) && args.equals(((AvroCall) o).args);
    }
