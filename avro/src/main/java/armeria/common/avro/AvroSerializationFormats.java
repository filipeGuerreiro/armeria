...
public final class AvroSerializationFormats {
     ...
     */
    public static final SerializationFormat BINARY = SerializationFormat.of("abinary");

    /**
     * Avro JSON serialization format.
     */
    public static final SerializationFormat JSON = SerializationFormat.of("ajson");


    private static final Set<SerializationFormat> THRIFT_FORMATS = ImmutableSet.of(BINARY, JSON);
