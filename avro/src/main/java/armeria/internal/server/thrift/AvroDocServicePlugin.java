...
package armeria.internal.server.thrift;
...
public final class AvroDocServicePlugin implements DocServicePlugin {
    ...
    private final AvroDocStringExtractor docstringExtractor = new AvroDocStringExtractor();
    ...
    public ServiceSpecification generate(List<Entry> entries, DocServiceFilter filter) {
        ...
        return ServiceSpecification.generate(services, AvroDocServicePlugin::newNamedTypeInfo);
    }
