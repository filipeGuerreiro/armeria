...
/**
 * The information about a Thrift service served by {@link AvroHttpService} or {@link AvroCallService}.
 *
 * @see AvroHttpService#entries()
 * @see AvroCallService#entries()
 */
public final class AvroServiceEntry {

    final String name;
    final Iterable<?> implementations;
    final Schema metadata;

    AvroServiceEntry(Map.Entry<String, ? extends Iterable<?>> entry) {
        ...
        metadata = new Protocol(implementations);
    }
